...
const SpecConfig = require('../admin.configuration/SpecConfiguration');
...
const SpecializationRepository = function () {
    ...
    this.updateSpecialization = (id, data) => {
        return new Promise((resolve, reject) => {
            Specialization.findOneAndUpdate(
                {specializationID: id.toString()},
                {name: data.name},
